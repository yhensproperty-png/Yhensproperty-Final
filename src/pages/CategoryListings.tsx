...
const CategoryListings: React.FC<CategoryListingsProps> = ({ properties }) => {
  ...
  const categoryDescriptions: Record<string, { title: string; description: string }> = {
    ...
    'rent-commercial': {
      ...
      description: 'Find commercial properties for rent including office spaces, retail locations, and business facilities. Explore flexible lease options for your business needs.'
    }
  };
