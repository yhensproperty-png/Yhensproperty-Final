              ...
              <form className="space-y-4" onSubmit={handleInquirySubmit}>
                ...
                <div className="flex flex-col gap-3 pt-1">
                  ...
                  <button
                    ...
                    className="w-full bg-[#0084FF] text-white font-black py-3.5 rounded-xl shadow-xl hover:brightness-110 active:scale-[0.98] transition-all flex items-center justify-center gap-2.5"
                  >
                    <svg className="w-5 h-5 fill-white" viewBox="0 0 24 24">
                    ...
                    <span className="text-base">Message on Messenger</span>
                  </button>
                </div>
              </form>
            </div>
