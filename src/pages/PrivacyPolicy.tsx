...
export default function PrivacyPolicy() {
  return (
    <>
      <SEO
        title="Privacy Policy - Yhen's Property"
        description="Privacy policy for Yhen's Property - Learn how we collect, use, and protect your personal information."
        canonical="https://yhensproperty.com/privacy-policy"
        ogType="website"
        ogUrl="https://yhensproperty.com/privacy-policy"
          ...
          <div className="space-y-8 text-gray-700">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Personal Information:</strong> Name, email address, phone number, and mailing address when you contact us or register for an account.</li>
                <li><strong>Property Preferences:</strong> Search criteria, saved properties, and property viewing history.</li>
                <li><strong>Technical Data:</strong> IP address, browser type, device information, and usage data collected through cookies and analytics.</li>
                <li><strong>Communication Data:</strong> Messages, inquiries, and feedback you send to us.</li>
                <li><strong>Seller Information:</strong> Property details and contact information when you submit a property listing.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>To provide and maintain our real estate listing services</li>
                <li>To respond to your inquiries and property viewing requests</li>
                <li>To send you property updates and marketing communications (with your consent)</li>
            ...
            <section>
              ...
              <p>
                ...
                and personalize content. You can control cookie settings through your browser preferences. Note that disabling
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Property Owners/Agents:</strong> When you express interest in a property</li>
            ...
            <section className="border-t pt-6 mt-8">
              <p className="text-sm text-gray-600">
                This privacy policy complies with applicable data protection laws including GDPR, CCPA, and CalOPPA requirements
