  ...
  return (
    <>
      <SEO
        ...
        ogType="website"
        ogUrl="https://yhensproperty.com/about"
        ogSiteName="Yhen's Property"
        ogImage="https://yhensproperty.com/Image/White_suit_manila_background_for_about_pic_720p_.png"
        ogImageWidth="1280"
        ogImageHeight="720"
        ogImageAlt="Yhen Oria - Experienced Real Estate Agent"
      />
